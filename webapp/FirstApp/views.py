...
import pandas as pd
import psycopg2
from .models import sarasconsultancy
...
def result(request):
    ...
    b = sarasconsultancy(age=request.GET['age'],sex=request.GET['sex'], bmi=request.GET['bmi'], children=request.GET['children'],
                         smoker=request.GET['smoker'], region=request.GET['region'], charges=answer)
    b.save()
